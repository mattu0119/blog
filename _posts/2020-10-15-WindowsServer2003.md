...
<img src="{{ site.url }}{{ site.baseurl }}/assets/images/WindowsServer/1-2003/1.png" class="full" width="600">
 
+ リモートデスクトップ
エラー内容は、**RPCサーバーを利用できません。**と表示されます。
<img src="{{ site.url }}{{ site.baseurl }}/assets/images/WindowsServer/1-2003/2.png" class="full" width="600">
